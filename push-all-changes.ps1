...
git commit -m "fix: исправлены ошибки и улучшен дизайн

- Исправлены ошибки типизации в telegram/database.ts
- Исправлена ошибка с group() в leaderboard
- Улучшен дизайн компонента TheoryBlock (более мягкие цвета)
- Исправлена обработка ошибок аналитики
- Создана таблица ai_feedback и исправлена отправка фидбека"
