export const ru = {
  ...
  aiAssistant: {
    ...
    explainConcept: 'Объясни концепцию',
    helpWithCode: 'Помоги с кодом',
    helpWithMyCode: 'Помоги с моим кодом',
    giveHint: 'Дай подсказку',
    studyAdvice: 'Совет по обучению',
    welcomeMessage: 'Привет! 👋 Я твой AI-помощник по изучению программирования. Чем могу помочь?',
    testResponse: 'Это тестовый ответ. API интеграция будет добавлена позже.',
    codeBlock: {
      copy: 'Копировать',
      copied: 'Скопировано',
      copyCode: 'Копировать код',
      codeCopied: 'Код скопирован!',
      codeAddedToClipboard: 'Код добавлен в буфер обмена',
