...
СТИЛЬ НАПИСАНИЯ:
• Пиши ДРУЖЕЛЮБНО, как будто объясняешь другу (используй "ты", не "студент")
• Короткие предложения (макс. 15-20 слов)
• Абзацы по 2-3 предложения
• Используй аналогии: "переменная — как коробка", "цикл — как повторить действие"
• Мотивируй: "это легко", "ты уже можешь это сделать"
...
✅ ЧЕКЛИСТ КАЧЕСТВА (проверь перед отправкой):

ТЕОРИЯ:
□ Вступление объясняет "что" и "зачем" простыми словами (2-4 предложения)
□ Все основные концепции объяснены с примерами (минимум 3-5 понятий)
□ Есть 3-5 примеров кода, от простого к сложному
□ Все примеры кода рабочие и самодостаточные (можно скопировать и запустить)
□ Указаны типичные ошибки новичков и как их избежать
□ Нет терминов из других языков программирования
□ Нет концепций, которые ещё не изучены (согласно дню ${day})
□ Стиль дружелюбный, мотивирующий

ЗАДАЧИ:
□ Ровно 5 задач с плавным нарастанием сложности
□ Каждая задача на 1-2 действия сложнее предыдущей
□ Все задачи по теме "${dayTopic}" и не выходят за её рамки
□ Формулировки конкретные и понятные (с примерами и точными значениями)
□ Подсказки направляющие, не дают полное решение (1 предложение)
□ Задачи соответствуют уровню дня ${day}
□ Нет запрещённых конструкций для этого дня
□ Каждая задача решаема за указанное время (EASY: 1-3 мин, MEDIUM: 3-5 мин, HARD: 5-8 мин, CHALLENGE: 8-12 мин)

ТЕХНИЧЕСКИЕ:
□ Валидный JSON формат (все кавычки двойные, экранированы спецсимволы)
